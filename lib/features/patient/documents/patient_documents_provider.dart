...
class PatientDocumentsProvider extends ChangeNotifier {
  PatientDocumentsProvider(this._repository) {
  ...
  List<HealthDocument> documentsForPatient(String patientId) {
    var docs = _repository.documentsForPatient(patientId);
      ...
      docs = docs
          .where(
            (doc) =>
                ...
                doc.uploadedByName.toLowerCase().contains(query),
          )
          .toList();
    }
    return docs;
